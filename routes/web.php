...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/external/register', [ExternalAuthController::class, 'showRegisterForm'])->name('external.register');
    Route::post('/external/register', [ExternalAuthController::class, 'register'])->name('external.register.process');

    Route::get('/external/login', [ExternalAuthController::class, 'showLoginForm'])->name('external.login');
    Route::post('/external/login', [ExternalAuthController::class, 'login'])->name('external.login.process');

    Route::get('/external/verify/{token}', [ExternalAuthController::class, 'verifyEmail'])->name('external.verify');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/external/logout', [ExternalAuthController::class, 'logout'])->name('external.logout');
    ...
    Route::get('/home', function () {
        return match (strtolower(Auth::user()->role)) {
            ...
            'external' => redirect()->route('external.dashboard'),
    ...
    Route::middleware(['userAccess:external'])->get('/external/dashboard', [DashboardController::class, 'external'])->name('external.dashboard');
    ...
    Route::middleware(['userAccess:admin,kepala sumber daya,ketua tim,pegawai,external'])->group(function () {
    ...
    Route::post('/borrowings/{id}/assign-driver', [BorrowingController::class, 'assignDriver'])
        ->name('borrowings.assign-driver');
