...
class FlatsarSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            ['SAYUDI YUSUF GINANJAR', '199011282009121001', 'sayudi.ginanjar@basarnas.go.id', '085215705557', 'Pegawai', null],
            ...
            ['IMAM TAUFIQ', '199409132015031001', 'imam.taufiq@basarnas.go.id', '082188222298', 'Ketua Tim', 'ECHO'],
            ...
            ['IRVAN RAHARJAN', '199704042017121007', 'irvan.raharjan@basarnas.go.id', '082259060936', 'Pegawai', null],
            ['MOH.RIVAI', '199701162017121003', 'moh.rivai@basarnas.go.id', '082271348332', 'Pegawai', 'BRAVO'],
            ['ALI FAJAR ZODIK', '199706062017121006', 'ali.zodik@basarnas.go.id', '085256500364', 'Pegawai', null],
            ...
            ['IMRAN AMINULLAH', '200109222025061003', 'imran.aminullah@basarnas.go.id', '087837852799', 'Pegawai', null],
            ...
            ['HAIKAL ANANDA PRATAMA', '200210012025061001', 'haikal.pratama@basarnas.go.id', '083863222189', 'Pegawai', null],
            ...
            ['FIRGIANSYAH', '200207212025061002', 'firgiansyah.firgiansyah@basarnas.go.id', '085117404797', 'Pegawai', null],
            ...
            ['MOH.RIYADIN FIRLY', '200002152020121004', 'moh.syach@basarnas.go.id', '082386033578', 'Pegawai', 'BRAVO'],
            ['ASRUL RUSANI', '198905302015031003', 'asrul.rusani@basarnas.go.id', '085398888686', 'Pegawai', 'ECHO'],
        ];
