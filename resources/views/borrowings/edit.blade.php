        ...
        <div class="col-12">
            <div class="bg-light text-center rounded p-4">
                ...
                <form action="{{ route('borrowings.update', $borrow->id) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                    ...
                    {{-- FILE UPLOAD: Surat Tugas atau Lampiran --}}
                    <div class="col-md-6">

                        @if($isExternal)
                            {{-- Jika peminjam adalah EXTERNAL --}}
                            <label for="lampiran" class="form-label w-100 text-start">Lampiran (PDF)</label>
                            ...
                            @if($borrow->lampiran_path)
                                <div class="mt-2 text-start">
                                    <a href="{{ asset('storage/' . $borrow->lampiran_path) }}" target="_blank">
                        ...
                        @else
                            ...
                            @if($borrow->surat_tugas_path)
                                <div class="mt-2 text-start">
                                    <a href="{{ asset('storage/' . $borrow->surat_tugas_path) }}" target="_blank">
