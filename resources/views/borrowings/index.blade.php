        ...
        <table class="table table-hover align-middle text-center" id="borrowingsTable">
            <thead class="table-light">
                <tr>
                    ...
                    <th data-col="driver" style="white-space: nowrap;">Supir</th>
            ...
            <tbody>
                @forelse($borrowings as $borrow)
                    <tr>
                        ...
                        <td data-col="driver" style="white-space: nowrap;">
                            @if($borrow->user->role === 'External')
                                {{ $borrow->driver->name ?? '-' }}
                            @else
                                -
                            @endif
                        ...
                        <td class="position-sticky end-0 bg-white">
                            <div class="btn-group btn-group-sm" role="group">
                                ...
                                @if(auth()->id() === $borrow->user_id)
                                    ...
                                    @if(auth()->user()->role !== 'External' && $borrow->status === 'In Use')
                                ...
                                {{-- SUPIR YANG DITUGASKAN JUGA BISA SELESAIKAN --}}
                                @if(auth()->id() === $borrow->driver_id)

                                    {{-- Supir hanya bisa Selesaikan jika status In Use --}}
